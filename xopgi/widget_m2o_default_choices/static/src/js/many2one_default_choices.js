openerp.widget_m2o_default_choices = function (instance) {
    var _t = instance.web._t,
        _lt = instance.web._lt;
    var QWeb = instance.web.qweb;

    instance.web.form.FieldMany2OneDefaultChoices = instance.web.form.FieldMany2One.extend({
        ...
        get_default_choices: function (search_val) {
            ...
            return this.orderer.add(dataset.name_search(
                search_val, new instance.web.CompoundDomain(self.build_priority_domain(), [["id", "not in", blacklist]]),
    ...
    instance.web.form.widgets.add('many2one_default_choices', 'instance.web.form.FieldMany2OneDefaultChoices');
